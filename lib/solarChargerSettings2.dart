...
class SolarChargerSettings2 extends StatefulWidget {
  @override
  _SolarChargerSettings2State createState() => _SolarChargerSettings2State();
}

class _SolarChargerSettings2State extends State<SolarChargerSettings2> {
